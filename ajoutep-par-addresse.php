...
<form method="post">
    ...
    <label><h4>nom du produit</h4></label><input type="text" name="nom" size=20 placeholder=" nom "><br>
    <label><h4>prix </h4></label><input type="number" name="prix" size=20 placeholder="prix "><br>
    <label><h4>description </h4></label><input type="text" name="desc" size=20 placeholder=" description "><br>
    <label><h4>nembre dans le stock </h4></label><input type="number" name="stock" size=20 placeholder=" nembre de stock"><br>
